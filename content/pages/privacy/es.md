...
description: Esta política de privacidad le informa sobre cómo TURING procesa sus datos personales cuando visita TURING DataMart y cuando utiliza una de nuestras funcionalidades de mercado. Además, esta política de privacidad le informa sobre sus derechos.
---
...
Los datos personales son cualquier información que pueda estar (directa o indirectamente) relacionada con usted. TURING procesa una cantidad mínima de datos personales, ya que creemos que sus datos personales le pertenecen. Procesamos los siguientes datos personales:

**Dirección IP** : Su dirección IP se procesa cuando visita TURING DataMart.

Si está utilizando una de nuestras funcionalidades de mercado, TURING también procesa los siguientes datos personales:
...
Si se comunica con TURING por correo electrónico, procesamos su dirección de correo electrónico y cualquier dato personal que decida proporcionar en su mensaje (como su nombre).
...
Recopilamos y usamos su dirección IP para proporcionar TURING DataMart alojado en Netlify. Además, TURING utiliza Netlify Analytics para recopilar y almacenar su dirección IP. Sus datos personales nunca abandonarán nuestro servicio y no lo rastreamos a través de los sitios.
...
TURING divulga su dirección de cartera transmitiéndola a un contrato inteligente (Smart Contract) almacenado en formato legible por máquina de forma permanente en cadena para permitir una pista de auditoría inmutable.
...
TURING divulga su dirección de cartera y nombre de autor transmitiéndolos a un contrato inteligente almacenado en formato legible por máquina de forma permanente en cadena para habilitar una pista de auditoría.

## 4.4 Mostrar activos de datos

Cuando publica un activo de datos, recuperamos, organizamos y almacenamos su dirección de cartera y nombre de autor en una caché de metadatos operada por TURING. Además, mostramos su activo en TURING DataMart.
...
Si se comunica con nosotros por correo electrónico, TURING recopilará, utilizará y almacenará su dirección de correo electrónico y cualquier otra información que nos proporcione en su mensaje, como su nombre.
...
TURING elimina sus datos personales tan pronto como ya no los necesitemos para procesar su consulta, exceptuando el caso en el que TURING esté obligada a cumplir con los períodos de retención legales o en caso de disputas legales.
<br/><i id="cookies"></i>
...
TURING DataMart contiene enlaces a sitios web externos que están más allá del control y la responsabilidad de TURING. Marcamos los enlaces externos con esta flecha: &#8599;.
...
Tiene derecho a obtener confirmación sobre si TURING procesa datos personales sobre usted. Si estamos procesando sus datos personales, tiene derecho a acceder a los mismos y obtener la información definida en el Art. 15 del GDPR.
...
TURING aceptará sus cambios lo antes posible. Puede esperar que los cambios se procesen en una semana. Para obtener más información, visite nuestra [**documentación del Purgatory** &#8599;](https://github.com/oceanprotocol/list-purgatory/blob/main/policies/README.md).
